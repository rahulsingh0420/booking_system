<x-guest-layout>
    <div class="text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-900 mb-2">Registration Pending Approval</h2>
        
        <p class="text-gray-600 mb-6">
            Thank you for registering as a renter. Your account is pending approval by an administrator.
